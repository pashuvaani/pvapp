          ...
          CustomCard(
            child: Column(
              ...
              children: [
                ...
                Text('Prescription: Intramammary Antibotic Infusion + Anti-inflammatory 3 days.', style: AppStyles.subtext),
                const Divider(height: 20),
                Row(
                  children: [
                    const Icon(Icons.picture_as_pdf_rounded, color: AppColors.emergencyRed, size: 20),
                    const SizedBox(width: 8),
                    const Text('Download Prescription PDF', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.primaryDeepGreen)),
                    const Spacer(),
