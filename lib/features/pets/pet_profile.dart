...
import '../../shared/components/pet_avatar.dart';
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Column(
                children: [
                  const PetAvatar(species: 'Cattle', radius: 44, isSelected: true),
            ...
            CustomCard(
              child: Column(
                children: [
                  ...
                  const Divider(height: 20),
                  _buildDetailRow('Gender / Status', 'Female • Lactating (Phase 2)'),
                  const Divider(height: 20),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Health Records & Prescriptions', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                ...
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Vaccination Schedule', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                        Text('Next Booster: FMD Vaccine (Due in 5 days)', style: TextStyle(color: AppColors.emergencyRed, fontSize: 12, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  const Icon(Icons.arrow_forward_ios_rounded, size: 16, color: AppColors.secondaryText),
